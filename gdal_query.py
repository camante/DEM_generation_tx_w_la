#!/usr/bin/env python
 ...
 # -
 # Description: Compare the values found in a source 'xyz' ascii
...
def Usage():
    ...
    print('  \t\tOptions are [x][y][z][g][d][p][c][s]; where z is the input z value, g is the grid ')
    print('  \t\tz value, d is the difference between the input z value and grid')
    print('  \t\tz value, p is the product of the input z value and the grid z vallue,')
