...
function help () {
echo "las2xyz - A simple script that converts all .laz files in a directory to .xyz files and reprojects to geographic coords for a provided classification"
	echo "Usage: $0 class"
